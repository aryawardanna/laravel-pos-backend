                        ...
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description"
                                            ...
                                            placeholder="Catatan pembelian (opsional)">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted mb-2">
                                    Setiap baris menjadi satu batch tersendiri, sehingga satu bahan baku dapat
                                    memiliki beberapa batch dengan harga beli dan tanggal kedaluwarsa berbeda.
                                </small>
...
@endphp
    <script>
        ...
        $(document).ready(function () {
            ...
            // satu baris kosong saat form create dibuka
            if ($('#item-rows .purchase-item').length === 0) {
                addItemRow();
            }
        });
    </script>
