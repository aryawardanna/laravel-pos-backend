                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $opname->code }}" readonly>
                                        <small class="form-text text-muted">Nomor opname tidak berubah.</small>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="opname_date"
                                            ...
                                            value="{{ old('opname_date', $opname->opname_date?->format('Y-m-d')) }}">
                                        @error('opname_date')
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="status" value="0" class="selectgroup-input"
                                                    {{ old('status', (string) $opname->status) == '0' ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Draft</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="status" value="1" class="selectgroup-input"
                                                    {{ old('status', (string) $opname->status) == '1' ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Selesai</span>
                                            </label>
                                        </div>
                                        <small class="form-text text-muted">
                                            Pilih Selesai bila selisih langsung diterapkan ke stok.
                                        </small>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description"
                                            ...
                                            placeholder="Catatan opname (opsional)">{{ old('description', $opname->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted mb-2">
                                    Stok sistem yang tampil adalah stok saat ini; selisih dihitung ulang saat disimpan.
                                </small>
                                ...
                                <div id="item-rows">
                                    @foreach ($opname->items as $item)
                                        <div class="opname-item border rounded p-2 mb-2">
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group mb-1">
                                                        <label class="mb-1">Stok Sistem</label>
                                                        <div class="form-control-plaintext pt-0 system-stock">0</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group mb-1">
                                                        <label class="mb-1">Jumlah Fisik</label>
                                                        <div class="input-group">
                                                            <input type="number" step="0.001" min="0"
                                                                name="items[physical_stock][]" class="form-control"
                                                                value="{{ FormatQtyInput($item->physical_stock) }}">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text satuan-badge">-</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group mb-1">
                                                        <label class="mb-1">Selisih</label>
                                                        <div class="form-control-plaintext pt-0 font-weight-bold difference text-muted">0</div>
                                                        <small class="form-text text-muted mb-0">
                                                            Tercatat: {{ $item->isIncrease() ? '+' : '' }}{{ FormatQty($item->difference) }}
                                                        </small>
                                                    </div>
                                                </div>
...
@endphp
    <script>
        ...
        $(document).ready(function () {
            ...
            // baris existing: isi stok sistem, satuan, dan selisih
            $('.opname-item').each(function () {
                updateRow($(this));
            });
        });
